...
const (
	...
	ERROR_DUPLICATE_FAVORITE = 10010

	// code= 20000... 订单模块的错误
	ERROR_COINS_NOT_ENOUGH      = 20001
	ERROR_ORDER_NOT_EXIST       = 20002
	ERROR_ORDER_TIMEOUT         = 20003
	ERROR_ORDER_STATUS_WRONG    = 20004
	ERROR_ORDER_DUPLICATE_REPLY = 20005
...
var codeMsg = map[int]string{
	...
	ERROR_DUPLICATE_FAVORITE: "已收藏过该顾问",
	//订单模块
	ERROR_COINS_NOT_ENOUGH:      "金币不足",
	ERROR_ORDER_NOT_EXIST:       "订单不存在",
	ERROR_ORDER_TIMEOUT:         "订单已过期",
	ERROR_ORDER_STATUS_WRONG:    "订单状态错误",
	ERROR_ORDER_DUPLICATE_REPLY: "订单已回复",
	//数据库错误
